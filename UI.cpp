...
constexpr char blood_img_path[] = "./assets/image/blood.png";
...
UI::draw() {
	...
	// al_draw_filled_rectangle(game_field_length, love_img_padding,game_field_length+blood_width,love_img_padding+blood_height,color_b);
	// al_draw_filled_rectangle(game_field_length, love_img_padding,game_field_length+blood_width*(DC->player->HP/DC->player->full_HP),love_img_padding+blood_height,color);

	//blood original
	// al_draw_filled_rectangle(0, DC->window_height-blood_height-15, 0+blood_width, DC->window_height, color_b);
	// al_draw_filled_rectangle(0, DC->window_height-blood_height-15, 0+blood_width*(DC->player->HP/DC->player->full_HP), DC->window_height, color);

	// al_draw_filled_rectangle(55, DC->window_height-blood_height+10, 0+blood_width-15, DC->window_height-blood_height+10+25, color_b);
	al_draw_filled_rectangle(55, DC->window_height-blood_height+10, (0+blood_width-15)*(DC->player->HP/DC->player->full_HP), DC->window_height-blood_height+10+25, color);
	al_draw_bitmap(IC->get(blood_img_path), 0, DC->window_height-blood_height-20, 0);

	
    // al_draw_bitmap(love, 0, DC->window_height-blood_height-15, 0);
	...
	al_draw_textf(
		FC->courier_new[FontSize::LARGE], al_map_rgb(200, 200, 200),
		blood_width, DC->window_height-blood_height,
		ALLEGRO_ALIGN_LEFT, "score: %5d", player_score);
